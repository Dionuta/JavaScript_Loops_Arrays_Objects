...
//Added break points to fix problem to fix search
while(true){
search = prompt("Search for product in our store. Type 'list' or 'all' to show all of the store's products and 'quit' to exit");
